...
namespace CoDemoLauncher
{
    ...
    /// </summary>
    public partial class CoDemoLauncherForm : Form
    {
...
// begin callbacks
        ...
        private void open_Event(object sender, EventArgs e)
        {
            ...
            {
                new CoDemoEditorForm(dialog.FileName, this.gameClient).ShowDialog(this);
            }
        }
        ...
        private void mruFileOpen_Event(object sender, EventArgs e)
        {
            if (sender is ToolStripMenuItem)
            {
                ...
                if (System.IO.File.Exists(demoFileName))
                {
                    ...
                    new CoDemoEditorForm(demoFileName, this.gameClient).ShowDialog(this);
                }
                else
                {
        ...
        /// <summary>
        /// Callback for "Help" event. Visits the CoDemoLauncher wiki.
        /// </summary>
        /// <param name="sender">Triggering UI element</param>
        /// <param name="e">Event arguments</param>
        ...
        /// <summary>
        /// Callback for "Visit Homepage" event. Visits the CoDemoLauncher homepage.
        /// </summary>
        /// <param name="sender">Triggering UI element</param>
        /// <param name="e">Event arguments</param>
        ...
        /// <summary>
        /// Callback for "Forum Thread" event. Visits the CoDemoLauncher
        ...
        private void options_Event(object sender, EventArgs e)
        {
            ...
            {
                this.RefreshListBusy();
                if(this.config.GetBoolValue(CoDemoLauncherForm.DemoLauncherIniGroup, CoDemoLauncherForm.EnableAutoUpdateIniKey))
                {
                    this.StartAutoUpdateThread(this.config.GetIntValue(CoDemoLauncherForm.DemoLauncherIniGroup, CoDemoLauncherForm.AutoUpdateIntervalMsIniKey));
                }
                UpdateMruFileList();
            }
        }
...
// end callbacks
        ...
        private void ShowDemoEditorForSelectedDemo()
        {
            if (this.CheckSelectedFile())
            {
                ...
                new CoDemoEditorForm(this.gameClient.GetDemoPath(this.GetSelectedDemo()), this.gameClient).ShowDialog(this);
        ...
        /// <summary>
        /// Checks the web for online updates of CoDemoLauncher
        /// </summary>
...
// begin model <--> view conversion
        ...
        public ListViewItem CreateListViewItem(DemoInfo demo)
        {
            return new ListViewItem(new string[]
            {
                demo.FileName,
                demo.MapName,
                CoDemoLauncherForm.CustomDurationConvert(demo.StartTime, demo.EndTime),
                demo.Character,
                CoDemoLauncherForm.CustomTimeConvert(demo.Create),
                CoDemoLauncherForm.CustomTimeConvert(demo.Modify),
