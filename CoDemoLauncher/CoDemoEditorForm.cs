...
namespace CoDemoLauncher
{
    ...
    /// </summary>
    public partial class CoDemoEditorForm : Form
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public CoDemoEditorForm(string filename, GameClient gameClient)
        {
            InitializeComponent();
...
// end callbacks
        ...
        private void RefreshFileInfo()
        {
            ...
            if (this.demo != null)
            {
                ...
                this.durationDisplayLabel.Text = CoDemoLauncherForm.CustomDurationConvert(demo.StartTime, demo.EndTime);
                this.characterDisplayLabel.Text = demo.Character;
                this.createdDisplayLabel.Text = CoDemoLauncherForm.CustomTimeConvert(demo.Create);
                this.modifiedDisplayLabel.Text = CoDemoLauncherForm.CustomTimeConvert(demo.Modify);
